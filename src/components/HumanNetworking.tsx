...
const features = [
  {
    title: "Better fits",
    description: "Authentic human introductions to find the right people and opportunities.",
    icon: (
  ...
  {
    title: "Less noise",
    description: "No public broadcast of roles or resumes to sift through.",
    icon: (
  ...
  {
    title: "More warmth",
    description: "More human-to-human interactions for everyone.",
    icon: (
...
export function HumanNetworking() {
  return (
      ...
      <Container>
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
            InterviewCrew amplifies human insight and facilitates connections, to help incredible people find each other.
          </p>
        </div>
